...
Version  : 22.08.1
Release  : 45
URL      : https://download.kde.org/stable/release-service/22.08.1/src/kblocks-22.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/kblocks-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/kblocks-22.08.1.tar.xz.sig
...
%prep
%setup -q -n kblocks-22.08.1
cd %{_builddir}/kblocks-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662770053
mkdir -p clr-build
pushd clr-build
