...
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/kblocks-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/kblocks-23.08.3.tar.xz.sig
...
%prep
%setup -q -n kblocks-23.08.3
cd %{_builddir}/kblocks-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699572497
mkdir -p clr-build
pushd clr-build
