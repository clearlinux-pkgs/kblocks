...
Version  : 19.08.3
Release  : 15
URL      : https://download.kde.org/stable/applications/19.08.3/src/kblocks-19.08.3.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.3/src/kblocks-19.08.3.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.3/src/kblocks-19.08.3.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573161621
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kblocks-19.08.3/COPYING %{buildroot}/usr/share/package-licenses/kblocks/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kblocks-19.08.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/kblocks/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang kblocks
